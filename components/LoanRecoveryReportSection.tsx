          ...
          <tbody className="text-sm">
            {processedData.length === 0 ? (
              ...
              <tr key={item.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                ...
                <td className="py-3 px-2">
                  <span className={`text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider ${item.type === LoanType.ADVANCE ? 'bg-blue-50 text-blue-600' : 'bg-purple-50 text-purple-600'}`}>
                    {item.type}
                  </span>
                </td>
