    ...
    data.attendance.forEach((record: any) => {
        ...
        if (d.getFullYear() === selectedYear && d.getMonth() === monthIndex) {
            ...
            if (entry) {
                ...
                else if (record.status === AttendanceStatus.HOLIDAY || record.status === AttendanceStatus.LEAVE) entry.Holiday++;
            }
        }
    });
          ...
          <div className="h-[300px] w-full">
            {dailyAttendanceData.length > 0 ? (
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={dailyAttendanceData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
